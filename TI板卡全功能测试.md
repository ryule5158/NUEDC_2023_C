...
- TI工程：`Keil/NUEDC_2023_D_MSPM0G3507.uvprojx`
- 烧录文件：`output/NUEDC_2023_D_MSPM0G3507_TI.hex`
- FPGA掉电启动镜像：`../FPGA/AD9708/output/BOOT_PS7.bin`
...
4. 在Program页面选择`output/NUEDC_2023_D_MSPM0G3507_TI.hex`。
...
2. 打开`Keil/NUEDC_2023_D_MSPM0G3507.uvprojx`。
